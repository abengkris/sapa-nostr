  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      ...
      <div className="sm:hidden sticky top-0 z-20 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 py-3">
        <Link href={`/${user?.npub || user?.pubkey}`}>
          <Image
      ...
      <div className="max-w-7xl mx-auto flex h-full">
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-30 border-t bg-white dark:bg-black border-gray-200 dark:border-gray-800 sm:relative sm:flex sm:flex-col sm:w-20 lg:w-64 sm:border-t-0 sm:border-r">
          <Sidebar />
        </nav>
